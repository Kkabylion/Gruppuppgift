...
const TempChart2 = () => {
    ...
    const options = {
        ...
        tooltip: {
            ...
            formatter: function () {
                return '<div style="background: linear-gradient(to bottom, #f5a623, #ff6347); padding: 5px; border-radius: 5px;">' +
                    'Date: ' + this.x + '<br>' +
        ...
        series: [{
            ...
            fillColor: {
                ...
                stops: [
                    [0, 'rgba(255, 255, 0, 0.75)'], // Här är kan man ändra på Skugg färgen för linjen.
                    [1, 'rgba(255,0,0,0.82)']     // semi transparent skugg färg.
                ]
            }
        }]
    };
    ...
    return (
        <div className="temp-chart-container2">
