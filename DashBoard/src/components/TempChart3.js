...
const TempChart3 = () => {
    ...
    const options = {
        ...
        xAxis: {
            ...
            labels: {
                style: {
                    color: '#FFFFFF' // Färgen på x-axelns Datum/tid Data är vit
                }
            }
        },
        ...
        yAxis: {
            ...
            labels: {
                style: {
                    color: '#FFFFFF' // Färgen på y-axelns Temp Data är vit.
                }
            }
        },
        tooltip: {
            ...
            formatter: function() {
                return '<div style="background: linear-gradient(to bottom, #ff89bb, rgba(242,147,255,0.58)); padding: 5px; border-radius: 5px;">' +
                    'Date: ' + this.x + '<br>' +
        ...
        series: [{
            ...
            fillColor: {
                ...
                stops: [
                    [0, 'rgba(32, 209, 126, 0)'], // Här är kan man ändra på Skugg färgen för linjen.
                    [1, 'rgb(255,137,187)'] // semi transparent skugg färg.
                ]
            }
        }]
    };
    ...
    return (
        <div className="temp-chart-container3">
